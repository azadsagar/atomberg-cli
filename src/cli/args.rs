...
pub struct DiscoverArgs {
    #[arg(long, default_value = "5", help = "Duration for which to listen for incoming device becons")]
    pub interval: u64,

    #[arg(long, default_value = "false", help = "Save captured unique devices to config file")]
    pub save: bool,
}
